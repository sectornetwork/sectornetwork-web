...
const isHeadingBlock = (block) => block.type.startsWith('heading_');
...
export const getBlockHast = (context, block) => {
    const blockType = isHeadingBlock(block) ? BlockType.heading : block.type;
