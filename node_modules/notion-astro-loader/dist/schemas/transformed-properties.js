...
export const number = propertyType.number.transform((property) => property.number);
...
export const phone_number = propertyType.phone_number.transform((property) => property.phone_number);
...
export const multi_select = propertyType.multi_select.transform((property) => property.multi_select.map((option) => option.name) ?? []);
